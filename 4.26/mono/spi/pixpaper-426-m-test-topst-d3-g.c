...
void epd_write_img() {
        ...
        printf("Writing 48000 bytes to display using batch write...\n");

        epd_writeDataBatch((uint8_t*)epd_image, 48000);

        printf("Batch write completed, starting update image\n");
